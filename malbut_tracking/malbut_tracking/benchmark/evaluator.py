...
def main(args=None) -> None:
    ...
    try:
        # Humble's global executor shutdown waits for running callbacks.
        # Finish the sampling callback before shutting down that executor.
        while rclpy.ok() and not node._finalized:
