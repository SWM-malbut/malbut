...
def generate_launch_description():
    ...
    default_lidar_config = package_share / 'config' / 'lidar_foreground.yaml'
    arguments = [
    ...
    lidar_preprocessor = IncludeLaunchDescription(
        PythonLaunchDescriptionSource(
            str(package_share / 'launch' / 'lidar_foreground.launch.py')
        ),
        launch_arguments={
    ...
    return LaunchDescription(arguments + [
        GroupAction([lidar_preprocessor], scoped=True), node,
    ])
