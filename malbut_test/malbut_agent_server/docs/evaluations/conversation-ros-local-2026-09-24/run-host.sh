...
# docker commit --pause=false malbut-speech-retry-test malbut-conversation-ros-local:20260924
repo_root=/Users/sinhyeonjae/Documents/ChatGPT/malbut
artifact_dir="$repo_root/malbut_agent_server/docs/evaluations/conversation-ros-local-2026-09-24"
docker run --name malbut-conversation-ros-check-20260924 --pull=never \
  ...
  malbut-conversation-ros-local:20260924 /results/run-in-container.sh
