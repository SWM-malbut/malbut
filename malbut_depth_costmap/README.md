# Malbut depth costmap input

`malbut_depth_costmap::DepthVoxelLayer` is a Nav2 costmap plugin, not a separate
point-cloud node. It projects a complete depth image once with the official
...
The package depends on official ROS 2 Humble `depth_image_proc` and
