...
class CloudFallMonitor:
    ...
    def _emit(self, kind: str, incident: Optional[FallIncident] = None,
        ...
        if self._journal is not None and incident is not None:
            try:
    ...
    async def _run_once(self) -> bool:
        ...
        if incident:
            ...
            # A separate association adapter turns suspect scan regions into
            # FallCandidates. Never merge an unidentified person by guesswork.
