...
artifact_dir="$repo_root/malbut_agent_server/docs/evaluations/conversation-ros-local-2026-09-24/post-fix"
docker run --name malbut-conversation-ros-fixed-20260924 --pull=never \
