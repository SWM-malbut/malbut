...
> 이전 상세 명세 보관본입니다. 현재 기준 문서는 [Malbut Agent 명세](AGENT_ROS2_INTERFACE_SPEC.md)입니다. 아래 내용은 작성 당시의 설계·검증 기록이며 현재 기준 명세를 대신하지 않습니다.
...
- [현재 ROS 인터페이스 생성 목록](../../malbut_interfaces/CMakeLists.txt)
- [현재 tracking의 사람 추적 Capability 등록](../../malbut_interfaces/capabilities/follow_person.yaml)
...
- [현재 FollowPerson Action](../../malbut_interfaces/action/FollowPerson.action)
